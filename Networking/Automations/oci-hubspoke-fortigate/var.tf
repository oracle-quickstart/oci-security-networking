...
variable "fortigate_image_ocid" {
  description = "The OCID of the Palo Alto image in Oracle Cloud Infrastructure (OCI)."
  type        = string
}
...
variable "forti_mgmt_subnet" {
  description = "CIDR block for the HUB VCN public subnet."
  type        = string
  default     = "10.30.0.0/24"
}

variable "forti_trust_subnet" {
  description = "CIDR block for the HUB VCN public subnet."
  type        = string
  default     = "10.30.1.0/24"
}

variable "forti_untrust_subnet" {
  description = "CIDR block for the HUB VCN public subnet."
  type        = string
