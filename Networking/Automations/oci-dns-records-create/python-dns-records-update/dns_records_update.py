...
# INPUTS
# ================================
ZONE_NAME = "ocid1.dns-zone.oc1.iad.aaaaa*******" #Update the Zone OCID
COMPARTMENT_ID = "ocid1.compartment.oc1..aaaaa******" #Update the Compartment OCID 
EXCEL_FILE = "dns_sample.xlsx" #Update the Excel file name 
