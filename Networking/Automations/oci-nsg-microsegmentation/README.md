# OCI Microsegmentation with Network Security Groups

## Introduction

This stack is designed to deploy a Virtual Cloud Network (VCN) with Network Security Groups (NSGs). This network architecture will show to easily write NSG security rules to control traffic between subnets within a VCN. This allows for microsegementation between different application functions.

## Network Scenario

This code will deploy the scenario from the related [blog] with the appropriate VCN subnets, NSGs, & NSG security rules.
![NSGs](images/nsgs.png).
...
[blog]: https://www.ateam-oracle.com/post/microsegementation-with-network-security-groups
...
[here]: https://github.com/oracle-quickstart/oci-nsg-microsegmentation/Resource-Manager
